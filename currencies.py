...
def parseData():
    ...
    table1 = (list(zip(bank_list_name,usd_cumparare,usd_vinzare,eur_cumparare,eur_vinzare, rub_cumparare, rub_vinzare,ron_cumparare,ron_vinzare,date_now)))
